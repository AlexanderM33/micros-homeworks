...
Так же многое зависит от сртаны реализации проекта, так как работа в периметре РФ накладывает соответствующие ограничения. Также наличние платных решений ставит вопрос о бюджете для решения задачи.
